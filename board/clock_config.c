...
outputs:
- {id: CLKOUT_clock.outFreq, value: 3 MHz}
- {id: System_clock.outFreq, value: 150 MHz}
settings:
- {id: PLL0_Mode, value: Normal}
- {id: ENABLE_CLKIN_ENA, value: Enabled}
- {id: ENABLE_SYSTEM_CLK_OUT, value: Enabled}
- {id: SYSCON.CLKOUTDIV.scale, value: '50', locked: true}
...
void BOARD_BootClockPLL150M(void)
{
    ...
    CLOCK_SetClkDiv(kCLOCK_DivClkOut, 50U, false);         /*!< Set CLKOUTDIV divider to value 50 */
